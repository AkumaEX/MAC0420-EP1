...
class RenderWidget(QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # create actor sublayout
        self._actorLayout = QHBoxLayout()
        self._actorLayout.setContentsMargins(0, 0, 0, 0)
        self._actorLayout.setSpacing(3)

        label = QLabel("Tessellated Sphere: ")
        label.setFont(self._font)
        self._actorLayout.addWidget(label)
        self._actorCombo = QComboBox(self)
        self._actorCombo.addItem("radius:1 / subdivision:1", Renderer.ActorType.SPHERE0)
        self._actorCombo.addItem("radius:1 / subdivision:5", Renderer.ActorType.SPHERE1)
        self._actorCombo.addItem("radius:1 / subdivision:10", Renderer.ActorType.SPHERE2)
        self._actorCombo.addItem("radius:1 / subdivision:20", Renderer.ActorType.SPHERE3)
        self._actorCombo.addItem("radius:2 / subdivision:20", Renderer.ActorType.SPHERE4)
        self._actorCombo.addItem("radius:3 / subdivision:20", Renderer.ActorType.SPHERE5)
        self._actorCombo.currentIndexChanged.connect(self._renderer.changeActor)
        self._actorCombo.setFont(self._font)
        self._actorLayout.addWidget(self._actorCombo)
        self._bottomLayout.addLayout(self._actorLayout)
