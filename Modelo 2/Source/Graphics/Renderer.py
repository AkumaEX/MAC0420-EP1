...
class Renderer(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        if not self._initialized:
            ...
            self._currentActor = Sphere(self._world, r=1, s=1)
    ...
    def changeActor(self, index):
        ...
        if index == Renderer.ActorType.SPHERE0:
            ...
            self._currentActor = Sphere(self._world, r=1, s=5)
        elif index == Renderer.ActorType.SPHERE2:
            self._currentActor = Sphere(self._world, r=1, s=10)
        elif index == Renderer.ActorType.SPHERE3:
            self._currentActor = Sphere(self._world, r=1, s=20)
        elif index == Renderer.ActorType.SPHERE4:
            self._currentActor = Sphere(self._world, r=2, s=20)
        elif index == Renderer.ActorType.SPHERE5:
            self._currentActor = Sphere(self._world, r=3, s=20)
